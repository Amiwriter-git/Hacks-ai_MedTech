...
model = RandomForestClassifier(n_estimators=100, max_depth=100, max_features=30, bootstrap=False)#LogisticRegression(random_state=0)#SVC(gamma = 'auto')#SVC(gamma = 2, C = 1.0)#RandomForestClassifier(n_estimators=100)#KNeighborsClassifier(n_neighbors=5)
models.append(model)
# ОНМК Острое нарушение мозгового кровообращения (ОНМК, инсульт)
model = RandomForestClassifier(n_estimators=100, max_depth=100, max_features=30, bootstrap=False)#LogisticRegression(random_state=0)#RandomForestClassifier(n_estimators=100)#LogisticRegression(random_state=0)#SVC(gamma = 'auto')#SVC(gamma = 2, C = 1.0)#RandomForestClassifier(n_estimators=100)#SVC(gamma = 2, C = 1.0)#SGDClassifier(max_iter = 1500, tol = 1e-4)#HistGradientBoostingClassifier(max_iter=100)#RandomForestClassifier(n_estimators=100)
models.append(model)
# Стенокардия, ИБС, инфаркт миокарда
model = RandomForestClassifier(n_estimators=100, max_depth=100, max_features=30, bootstrap=False)#LogisticRegression(random_state=0)#RandomForestClassifier(n_estimators=100)#LogisticRegression(random_state=0)#SVC(gamma = 'auto')#SVC(gamma = 2, C = 1.0)#RandomForestClassifier(n_estimators=100)
models.append(model)
# Сердечная недостаточность
model = RandomForestClassifier(n_estimators=100, max_depth=100, max_features=30, bootstrap=False)#LogisticRegression(random_state=0)#RandomForestClassifier(n_estimators=100)#LogisticRegression(random_state=0)#SVC(gamma = 'auto')#SVC(gamma = 2, C = 1.0)#RandomForestClassifier(n_estimators=100)
models.append(model)
# Прочие заболевания сердца
model = RandomForestClassifier(n_estimators=100, max_depth=100, max_features=30, bootstrap=False)#LogisticRegression(random_state=0)#RandomForestClassifier(n_estimators=100)#LogisticRegression(random_state=0)#RandomForestClassifier(max_depth = 10, n_estimators = 10, max_features = 1)#SVC(gamma = 'auto')#SVC(gamma = 2, C = 1.0)#RandomForestClassifier(n_estimators=100)
models.append(model)
